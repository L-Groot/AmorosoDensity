...
#dat <- rnorm(50, mean = 4)
#estimate_amoroso_np(dat, generatedbynormal = TRUE, withmean = 4, withsd = 1,
#                    xticks = c(0,4,8), minimal = FALSE, amorosocrit = "ML")

#estimate_amoroso_np(dat, minimal = TRUE, generatedbynormal = TRUE, withmean = 4, withsd = 1,
#                   xticks = c(0,4,8))
estimate_amoroso_np(dat, minimal = FALSE)
#estimate_amoroso_np(dat, minimal = FALSE, amorosocrit = "BIC")
#-------------------------------------------------------------------------------
